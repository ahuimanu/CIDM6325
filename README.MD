...
- Authentication (login/logout using Django’s built-in auth system)
- Templates for post list, detail, and form views
- Published date and time auto-fill
- Organized URL patterns for `/blog/` and `/blog/new/`
