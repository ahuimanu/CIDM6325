...
* Detecting and using HTTP Requests
    * GET and POST Django [QueryDict](https://docs.djangoproject.com/en/4.2/ref/request-response/#querydict-objects) objects to obtain HTTP request parameter values
