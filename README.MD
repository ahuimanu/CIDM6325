...
Basic Database              | [Databases and RDBMS](https://database.guide/what-is-a-database/)
asdf                        | [Relationships (1:1, 1:M, M:M)](https://database.guide/database-relationships-explained/)
