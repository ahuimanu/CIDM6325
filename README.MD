...
![Submitted Orders Table – With Receipt](./docs/module5uiImages/Loginworks_Crud.pngo)
![Password Encription and enforcement](./docs/module5uiImages/PasswordRule_Encryption_Effective.pngimg/media_config.png)
```
