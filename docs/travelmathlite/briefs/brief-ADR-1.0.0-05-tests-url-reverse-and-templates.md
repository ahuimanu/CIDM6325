# BRIEF: ADR-1.0.0 — Tests for URL reverse and template rendering
...
- Use Django TestCase (no pytest). Run via `uv run python manage.py test`.
- Keep tests deterministic and fast.

Acceptance

- Tests pass verifying REV and render per app.
...
- ADR: ADR-1.0.0 (§Test plan and invariants).
